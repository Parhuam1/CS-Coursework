...
.data
bigData QWORD abcdef0123456789h
...
;;;;;;         You should see a red circle appear in the grey border	;;;;;;
;;;;;;         if you've successfully set the breakpoint.		    	;;;;;;
...
;;;;;;         At the Debug pull down menu, select Step Into or select  ;;;;;;
;;;;;;         the key F11 to step through (execute) the line of code.	;;;;;;
...
;;;;;;			addresses of the memory, and the middle column is the   ;;;;;;
;;;;;;			data that's stored in memory.                           ;;;;;;
;;;;;;			The first bytes of data shown in the memory window      ;;;;;;
;;;;;;			is bigData's value.	Recall that each byte of data is    ;;;;;;
;;;;;;			2 hexadecimal digits.			     			        ;;;;;;
;;;;;;			Enter below what bigData looks like in memory.			;;;;;;

;    bigData in memory = 89 67 45 23 01 ef cd ab
